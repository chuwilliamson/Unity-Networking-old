...
{
	[SyncEvent]
	public static event PlayerChangeDelegate EventPlayerChange;

	static public GameStateManager singleton;
	...
	public int activePlayerIndex
	{
		...
		set {
			if (value >= m_Players.Count)
				m_activePlayerIndex = 0;
			else
				m_activePlayerIndex = value;
		}
	}
...
#region Setup
	...
	{
		singleton = this;
		EventPlayerChange += PlayerChange;
	...
	{		
		stackcount++;
		if (stackcount > 100)
			throw new UnityException ("stack overflow on player change");
